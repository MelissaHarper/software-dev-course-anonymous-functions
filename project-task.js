...
const todos = [
  ...
  */
  ...
  console.log("Sorted by Priority:", todosSorted);
  ...
  */
  ...
  const tasksCompleted =  todos.map(function(todo) {
  ...
  */
  ...
  const incompleteSorted = todos.filter(todo => todo.completed === false).sort  ((a, b) => a.priority - b.priority)
